...
//   // validaiton cehcking
//   const isFormValid = formData.labTest.trim().length > 0 && formData.result.trim().length > 0;

//   // sa pagination calculation 
...
//     if (recordToEdit) {
//       setFormData({
//         labTest: recordToEdit.labTest,
//         result: recordToEdit.result,
...
//         // adjust pagination if deleting the last item sa current page 
...
//       setCurrentPage(1); // pag jump to first page para mailing su newly added record
//     }
//   };
...
//           .selected-row > td { 
//             background-color: #e6f4ea !important; /* Soft green tint */
//             color: #0b592f !important; /* Darker text for contrast */
//           }
//           .selected-row > td:first-child { 
//             border-left: 4px solid var(--primary, #0f763f) !important; /* Bold accent border */
//           }
//           .selected-row .text-muted {
//             color: #0f763f !important; /* Make muted text match the theme when selected */
//           }
...
//                     <h5 className="fw-bold text-dark mb-0 text-center text-md-start text-uppercase">Pertinent Lab/Diagnostic Findings</h5>
...
//                           <tr>
//                             <th className="border-bottom py-3 px-4 text-dark fw-bold" style={{ width: "30%" }}>Laboratory Test</th>
//                             <th className="border-bottom py-3 px-4 text-dark fw-bold" style={{ width: "40%" }}>Result</th>
//                             <th className="border-bottom py-3 px-4 text-dark fw-bold" style={{ width: "30%" }}>Remark</th>
//                           </tr>
//                         </thead>
//                         <tbody>
...
//                                 <h6 className="fw-bold mb-1">No lab/diagnostic findings recorded.</h6>
...
//                               >
//                                 <td className="py-3 px-4 fw-medium text-dark align-top border-start-0">{record.labTest}</td>
//                                 <td className="py-3 px-4 text-wrap text-break align-top" style={{ maxWidth: "300px" }}>{record.result}</td>
//                                 <td className="py-3 px-4 text-muted align-top">{record.remark}</td>
//                               </tr>
//                             ))
//                           )}
//                         </tbody>
...
//                   {isEditing ? "EDIT" : "ADD"} PERTINENT LAB | RADIO | DIAGNOSTIC FINDINGS
//                 </h4>
...
//                 <div className="mb-3">
//                   <label className="fw-bold mb-1" style={{ color: "var(--primary, #0f763f)", fontSize: "0.85rem" }}>
//                     Lab | Radio | Diagnostic <span className="text-danger">*</span>
//                   </label>
//                   <input 
//                     type="text" 
//                     className={`form-control rounded-1 shadow-none ${!isFormValid && formData.labTest.length === 0 ? 'is-invalid' : ''}`} 
...
//                   </label>
//                   <textarea 
//                     className={`form-control rounded-1 shadow-none ${!isFormValid && formData.result.length === 0 ? 'is-invalid' : ''}`} 
//                     rows={6}
...
//                 <div className="mb-1">
//                   <label className="fw-bold mb-1" style={{ color: "var(--primary, #0f763f)", fontSize: "0.85rem" }}>Remark</label>
//                   <input 
//                     type="text" 
...
//                   Are you sure you want to delete this <strong className="text-danger">Finding</strong>?
//                 </p>
//               </div>
